  ...
  return (
    <>
      ...
      <div id="teacher">
        ...
        <div id="books">
          <div id="Ellipse-div"></div>
          <img src={image12} alt="/" />
          <div id="red-circle"></div>
          <div id="small-red-circle"></div>
      ...
      <div id="last-div">
        ...
        <div id="main-last-div">
          <section>
            ...
            <p className="million">
              className adds $30 million to its balance sheet for a
              Zoom-friendly edtech solution
            </p>
            <h4 className="backboard">
              className, launched less than a year ago by Blackboard co-founder
              Michael Chasen, integrates exclusively...
            </h4>
            <a href="cnb" className="anchor">
              Read more
            </a>
          </section>
          <section>
            <div className=" balance">
              ...
              <section>
                <p className="million">
                  className Technologies Inc. Closes $30 Million Series A
                  Financing to Meet High Demand
                </p>
                <h4 className="backboard">
                  className Technologies Inc., the company that created
                  className,...
                </h4>
              </section>
            </div>
