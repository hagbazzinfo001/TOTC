            ...
            {sectionTexts.map((text, index) => (
              <section key={index}>
                <div>
                  ...
                  <p
                    className={`dolor ${openIndex === index ? "show" : "hide"}`}
                  >
                    ...
                    amet, consectetur adipiscing elit, sed do eiusmod tempos
                    Lorem ipsum dolor sitamet, consectetur adipiscing elit, sed
                    do eiusmod temporLorem ipsum dolor sit amet, consectetur
